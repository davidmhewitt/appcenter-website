...
export default function AppSummaryButton({
  id,
  name,
  description,
  imageUrl,
  ...
  return (
    <Link href={`/app/${id}`}>
      <div className="block rounded-lg bg-white p-3 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700">
        <Image
          width={64}
          height={64}
