        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-md">
          ...
          >
            <TextBox
              name="email"
              autoComplete="email"
              title={t('form-labels.email-address', { ns: 'login' })}
            />
            ...
            <TextBox
              ...
              title={t('form-labels.password', { ns: 'login' })}
            />
            ...
            <div>
              ...
              >
                {t('form-labels.sign-in-button', { ns: 'login' })}
              </button>
            </div>
          </form>
          ...
          >
            ...
            {t('github-login', { ns: 'login' })}
          </Link>

          <p className="mt-10 text-center text-sm text-gray-500">
            {t('no-account', { ns: 'login' })}&nbsp;
            <Link
              href="/register"
              className="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"
            >
              {t('register-action', { ns: 'login' })}
            </Link>
          </p>
        </div>
      </div>
