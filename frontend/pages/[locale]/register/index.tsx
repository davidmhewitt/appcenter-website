...
function Register({ router }: RegisterProps) {
    const { t } = useTranslation(['register', 'server'])
    ...
    const [registerResult, setRegisterResult] = useState<any>({error: router.query?.error, translation_key: router.query?.error})
                        ...
                        <div className="flex">
                            <div className='w-full'>
                                <TextBox
                                    ...
                                    errorMessage={errors.confirmPassword?.message ? t(errors.confirmPassword.message) : undefined}
...
const getStaticProps = makeStaticProps(['register', 'server'])
